...
public class EvaluacionManager {
    ...
    public void realizarEvaluacion(Integer id, AltaEvaluacionTerminadaPojo respuestas, LocalDateTime logFecha){
        ...
        if(idEvaluacionesVehiculo.contains(evaluacion.getId())){
            ...
            if(!idsPreguntasEvaluacion.retainAll(idsPreguntasRespuestas)){
                ...
                saveLogsPregunta(log, loggedUser, vehiculo, respuestas.getRespuestas(), empresaId);
    ...
    public void saveLogsPregunta(LogEvaluacion log,  UsuarioView loggedUser, Vehiculo vehiculo, List<AltaRespuestaPojo> respuestas, int empresaId){
         ...
         for (AltaRespuestaPojo res : respuestas) {
